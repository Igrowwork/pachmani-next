...
export default function Benifit() {
  return (
    <div className="bg-[#FAF3EA] py-5 md:p-0 p-6">
      <div className=" max-w-7xl py-5 mx-auto w-full h-full">
        ...
        <div className="grid md:gap-10 gap-5">
          <div className="bg-white grid md:grid-cols-5 md:w-[70%] md:gap-8 gap-4 items-center">
          ...
          <div className="flex justify-end">
            <div className="bg-white grid md:grid-cols-5 md:w-[70%] gap-8 items-center">
