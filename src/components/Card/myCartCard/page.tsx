            ...
            {arr?.map((ele, i) => (
              <div className="grid md:grid-cols-7 grid-cols-1 items-center gap-3 rounded-md p-4 shadow-[2px_2px_20px_0px_rgba(0,0,0,0.10)]">
                ...
                <div className="md:col-span-4 gap-2">
                  <h1 className="text-base font-medium text-black">Black Shine Shampoo</h1>
                  <p className="text-sm text-[#625D60] my-2">It is a long established fact that a reader will be distracted by the </p>
                  <div className="grid grid-cols-3 items-center">
                    ...
                    <div className="text-xs flex items-center gap-1 text-ternary-main mt-2"> <span className="bg-[#2D8A40] text-white px-2 py-0.5 text-[0.625rem] rounded-full">4.5 &#9733;</span> <span className="text-xs">763 Rating</span></div>
                  </div>
                   <div className="border-primaryMain/25 border mt-4 w-full h-[0.5px] border-dashed"/>
                   <div className="text-[#625D60] text-sm flex gap-2 mt-3 items-center justify-between"> Subtotal <span className="font-semibold text-[#313131]">₹265.00</span> </div>
