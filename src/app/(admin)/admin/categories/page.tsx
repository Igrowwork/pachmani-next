            ...
            arr?.map((ele,i)=> (
                <div className='grid grid-cols-2 bg-white p-2 rounded-xl'>
                    ...
                    <div className='p-4'>
                        ...
                        <Link href={'/admin/add-product'}><button className='bg-primaryMain p-2 text-white rounded-sm w-full mt-4'>Add Product</button></Link>
                        <Link href={`categories/${ele?.path}`}><button className='text-primaryMain p-2 rounded-sm block w-full'>View all Product</button></Link>
                    </div>
