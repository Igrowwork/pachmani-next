    ...
    <div className='shadow-[2px_2px_20px_0px_rgba(0,0,0,0.10)] grid grid-cols-5 p-6 gap-12'>
      <div className='col-span-3'>
        <div className='flex justify-between bg-[#00AB551A] p-4 items-center w-full rounded-sm'>
            <span className={cn('text-2xl font-normal text-black' , forum.className)}>To use Amaaya points, vouchers, please log in</span>
            <Link href={'/login'} className='px-10 py-2 rounded-sm bg-primaryMain text-white font-medium text-xl'>Login</Link>
        </div>
        <div>
            ...
            <form onSubmit={handleSubmit} className='grid grid-cols-2 gap-6'>
                <div>
                    ...
                    <input type='text' name='firstname' value={isVal.firstname} onChange={handleChange} className='border border-[#625D60] outline-none p-2.5 rounded-lg w-full mt-1.5' placeholder='Please Enter Your First Name' required />
                </div>
                <div>
                    <h3 className='text-sm text-[#332F32] font-medium'>Last Name</h3>
                    <input type='text'  name='lastname'  value={isVal.lastname} onChange={handleChange} className='border border-[#625D60] outline-none p-2.5 rounded-lg w-full mt-1.5' placeholder='Please Enter Your Last Name' required />
                </div>
                <div>
                    <h3 className='text-sm text-[#332F32] font-medium'>Mobile Number</h3>
                    <input type='number'  name='mobile' value={isVal.mobile} onChange={handleChange}  className='border border-[#625D60] outline-none p-2.5 rounded-lg w-full mt-1.5' placeholder='Please Enter Your Mobile Number' required />
                </div>
                <div>
                    <h3 className='text-sm text-[#332F32] font-medium'>Email</h3>
                    <input type='email'  name='email' value={isVal.email} onChange={handleChange} className='border border-[#625D60] outline-none p-2.5 rounded-lg w-full mt-1.5' placeholder='Please Enter Your Email' required />
                </div>
                <div>
                    <h3 className='text-sm text-[#332F32] font-medium'>Pincode</h3>
                    <input type='number'  name='pincode' value={isVal.pincode} onChange={handleChange} className='border border-[#625D60] outline-none p-2.5 rounded-lg w-full mt-1.5' placeholder='Please Enter Your Pincode' required />
                </div>
                <div>
                    <h3 className='text-sm text-[#332F32] font-medium'>City</h3>
                    <input type='text'  name='city' value={isVal.city} onChange={handleChange} className='border border-[#625D60] outline-none p-2.5 rounded-lg w-full mt-1.5' placeholder='Please Enter Your City' required />
                </div>
                <div>
                    <h3 className='text-sm text-[#332F32] font-medium'>Country</h3>
                    <input type='text'  name='country' value={isVal.country} onChange={handleChange} className='border border-[#625D60] outline-none p-2.5 rounded-lg w-full mt-1.5' placeholder='Please Enter Your Country' required />
                </div>
                <div>
                    <h3 className='text-sm text-[#332F32] font-medium'>State</h3>
                    <input type='text'  name='state' value={isVal.state} onChange={handleChange} className='border border-[#625D60] outline-none p-2.5 rounded-lg w-full mt-1.5' placeholder='Please Enter Your State' required />
                </div>
                <div className='col-span-2'>
                    <h3 className='text-sm text-[#332F32] font-medium'>Address</h3>
                    <textarea  name='address' value={isVal.address} onChange={handleChange} className='border border-[#625D60] outline-none p-2.5 rounded-lg w-full mt-1.5 resize-none' placeholder='Please Enter Your Address' required />
                </div>
